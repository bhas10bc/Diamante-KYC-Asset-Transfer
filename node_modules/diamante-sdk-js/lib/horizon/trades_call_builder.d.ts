 ...
 * @extends CallBuilder
 * @constructor
 * @see [Trades](https://developers.diamante.org/api/resources/trades/)
...
export declare class TradesCallBuilder extends CallBuilder<ServerApi.CollectionPage<ServerApi.TradeRecord>> {
     ...
     * @see [Trades for Account](https://developers.diamante.org/api/resources/accounts/trades/)
     ...
     * @see [Trades for Liquidity Pool](https://developers.diamante.org/api/resources/liquiditypools/trades/)
