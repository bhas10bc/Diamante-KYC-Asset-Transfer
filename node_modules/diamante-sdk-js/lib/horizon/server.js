          ...
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              return _context4.abrupt("return", _horizon_axios_client.default.post((0, _urijs.default)(this.serverURL).segment("transactions").toString(), "tx=".concat(tx), {
                ...
                var responseXDR = _diamanteBase.xdr.TransactionResult.fromXDR(response.data.result_xdr, "base64");
                  ...
                  offerResults = results.map(function (result, i) {
                    ...
                    var offersClaimed = offerSuccess.offersClaimed().map(function (offerClaimedAtom) {
                      ...
                      switch (offerClaimedAtom.switch()) {
                        case _diamanteBase.xdr.ClaimAtomType.claimAtomTypeV0():
                          sellerId = _diamanteBase.StrKey.encodeEd25519PublicKey(offerClaimed.sellerEd25519());
                          break;
                        case _diamanteBase.xdr.ClaimAtomType.claimAtomTypeOrderBook():
                          sellerId = _diamanteBase.StrKey.encodeEd25519PublicKey(offerClaimed.sellerId().ed25519());
                          break;
                        default:
                      ...
                      var sold = _diamanteBase.Asset.fromOperation(offerClaimed.assetSold());
                      var bought = _diamanteBase.Asset.fromOperation(offerClaimed.assetBought());
                      var assetSold = {
                    ...
                    if (typeof offerSuccess.offer().value === "function" && offerSuccess.offer().value()) {
                      ...
                      var selling = _diamanteBase.Asset.fromOperation(offerXDR.selling());
                      currentOffer.selling = {
                        type: selling.getAssetType(),
                        assetCode: selling.getCode(),
                        issuer: selling.getIssuer()
                      };
                      var buying = _diamanteBase.Asset.fromOperation(offerXDR.buying());
                      currentOffer.buying = {
      ...
      var _checkMemoRequired = _asyncToGenerator(_regeneratorRuntime().mark(function _callee6(transaction) {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              if (transaction instanceof _diamanteBase.FeeBumpTransaction) {
