...
export namespace xdr {
  ...
  class ContractExecutableType {
    readonly name: 'contractExecutableWasm' | 'contractExecutableDiamanteAsset';

    readonly value: 0 | 1;

    static contractExecutableWasm(): ContractExecutableType;

    static contractExecutableDiamanteAsset(): ContractExecutableType;
  }
  ...
  class AuthenticatedMessageV0 {
    constructor(attributes: {
      sequence: Uint64;
      message: DiamanteMessage;
      mac: HmacSha256Mac;
    });

    sequence(value?: Uint64): Uint64;

    message(value?: DiamanteMessage): DiamanteMessage;
  ...
  class DiamanteMessage {
    ...
    static errorMsg(value: Error): DiamanteMessage;

    static hello(value: Hello): DiamanteMessage;

    static auth(value: Auth): DiamanteMessage;

    static dontHave(value: DontHave): DiamanteMessage;

    static getPeers(): DiamanteMessage;

    static peers(value: PeerAddress[]): DiamanteMessage;

    static getTxSet(value: Buffer): DiamanteMessage;

    static txSet(value: TransactionSet): DiamanteMessage;

    static generalizedTxSet(value: GeneralizedTransactionSet): DiamanteMessage;

    static transaction(value: TransactionEnvelope): DiamanteMessage;

    static surveyRequest(value: SignedSurveyRequestMessage): DiamanteMessage;

    static surveyResponse(value: SignedSurveyResponseMessage): DiamanteMessage;

    static getScpQuorumset(value: Buffer): DiamanteMessage;

    static scpQuorumset(value: ScpQuorumSet): DiamanteMessage;

    static scpMessage(value: ScpEnvelope): DiamanteMessage;

    static getScpState(value: number): DiamanteMessage;

    static sendMore(value: SendMore): DiamanteMessage;

    static sendMoreExtended(value: SendMoreExtended): DiamanteMessage;

    static floodAdvert(value: FloodAdvert): DiamanteMessage;

    static floodDemand(value: FloodDemand): DiamanteMessage;
    ...
    static read(io: Buffer): DiamanteMessage;

    static write(value: DiamanteMessage, io: Buffer): void;

    static isValid(value: DiamanteMessage): boolean;

    static toXDR(value: DiamanteMessage): Buffer;

    static fromXDR(input: Buffer, format?: 'raw'): DiamanteMessage;

    static fromXDR(input: string, format: 'hex' | 'base64'): DiamanteMessage;
  ...
  class ContractExecutable {
    ...
    static contractExecutableDiamanteAsset(): ContractExecutable;
