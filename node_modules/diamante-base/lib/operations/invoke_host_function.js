...
exports.createDiamanteAssetContract = createDiamanteAssetContract;
 ...
 *
 * @see https://soroban.diamante.org/docs/fundamentals-and-concepts/invoking-contracts-with-transactions#function
 * @see Operation.invokeContractFunction
 * @see Operation.createCustomContract
 * @see Operation.createDiamanteAssetContract
 ...
 *
 * @see
 * https://soroban.diamante.org/docs/fundamentals-and-concepts/invoking-contracts-with-transactions#function
 */
 ...
 *
 * @function
 * @alias Operation.createDiamanteAssetContract
 *
 * @param {any}          opts - the set of parameters
 ...
 *    (xdr.InvokeHostFunctionOp)
 *
 * @see https://diamante.org/protocol/sep-11#alphanum4-alphanum12
 * @see
 * https://soroban.diamante.org/docs/fundamentals-and-concepts/invoking-contracts-with-transactions
 * @see
 * https://soroban.diamante.org/docs/advanced-tutorials/diamante-asset-contract
 * @see Operation.invokeHostFunction
 */
function createDiamanteAssetContract(opts) {
  ...
  return this.invokeHostFunction({
    ...
    auth: opts.auth,
    func: _xdr["default"].HostFunction.hostFunctionTypeCreateContract(new _xdr["default"].CreateContractArgs({
      executable: _xdr["default"].ContractExecutable.contractExecutableDiamanteAsset(),
