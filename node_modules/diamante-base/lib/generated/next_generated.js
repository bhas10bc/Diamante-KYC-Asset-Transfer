...
var types = XDR.config(function (xdr) {
  ...
  //   {
  //       DIAMANTE_VALUE_BASIC = 0,
  //       DIAMANTE_VALUE_SIGNED = 1
  //   };
  //
  // ===========================================================================
  ...
  //       {
  //       case DIAMANTE_VALUE_BASIC:
  //           void;
  //       case DIAMANTE_VALUE_SIGNED:
  ...
  // === xdr source ============================================================
  //
  //   union DiamanteMessage switch (MessageType type)
  //   {
  //   case ERROR_MSG:
  //       Error error;
  //   case HELLO:
  ...
  //       {
  //           uint64 sequence;
  //           DiamanteMessage message;
  //           HmacSha256Mac mac;
  //       }
  //
  // ===========================================================================
  xdr.struct("AuthenticatedMessageV0", [["sequence", xdr.lookup("Uint64")], ["message", xdr.lookup("DiamanteMessage")], ["mac", xdr.lookup("HmacSha256Mac")]]);
  ...
  xdr["enum"]("ContractExecutableType", {
    ...
    contractExecutableDiamanteAsset: 1
  });
  ...
  xdr.union("ContractExecutable", {
    ...
    switchName: "type",
    switches: [["contractExecutableWasm", "wasmHash"], ["contractExecutableDiamanteAsset", xdr["void"]()]],
    arms: {
